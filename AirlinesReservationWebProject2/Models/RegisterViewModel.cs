...
namespace AirlinesReservationWebProject2.Models
{
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessage = "Ad Soyad is required.")]
        [StringLength(30, ErrorMessage = "Ad Soyad can be max 50 characters.")]
